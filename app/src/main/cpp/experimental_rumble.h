...
enum class RumbleEffect {
    ...
    GunRecoil,      // sharp, heavy gun-hand kick with a short counter-pulse
    GunMachinegun,  // rapid gun-hand burst with supporting off-hand pulses
    GunRevolver,    // rising, full-force, then falling revolver envelope
};
