...
public:
    ...
    // Switches port 2 (index 1) between a normal joypad and the Zapper, for
    // ROMs known to use it (Duck Hunt, Hogan's Alley, Wild Gunman, ...).
    // Call once after load_content() succeeds, before the first step_frame().
