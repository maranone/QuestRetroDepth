...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      "snes9x_auto_frame_skip",
      "Auto Frame Skip",
      "Let the emulator dynamically skip frames to maintain performance. When enabled, the emulator will drop frames if it's running too slow.",
      {
         { "disabled", NULL },
         { "enabled",  NULL },
         { NULL, NULL },
