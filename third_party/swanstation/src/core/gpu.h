...
public:
  ...
  // Read-only snapshot source for the libretro frontend's optional geometry
  // bridge. Hardware renderers keep a CPU shadow copy here as well.
  const uint16_t* GetVRAM() const { return m_vram_ptr; }
