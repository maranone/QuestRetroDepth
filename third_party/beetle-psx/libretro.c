...
#include "mednafen/psx/psx_qrd_capture.h"
...
void retro_run(void)
{
   ...
   */
   ...
   psx_qrd_scene_end(width, height,
         (uint16_t)espec->DisplayRect.x, (uint16_t)espec->DisplayRect.y,
         (uint16_t)espec->DisplayRect.w, (uint16_t)espec->DisplayRect.h);
