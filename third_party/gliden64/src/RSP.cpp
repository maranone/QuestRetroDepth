...
#define QRD_G64_RSP_LOG(...) __android_log_print(ANDROID_LOG_INFO, "GLideN64Hook", __VA_ARGS__)
#else
#define QRD_G64_RSP_LOG(...) ((void)0)
#endif
...
void RSP_ProcessDList()
{
	...
	if (calls <= 12 || (calls % 500) == 0)
		QRD_G64_RSP_LOG("RSP_ProcessDList entry=%u", calls);
	RSP.LLE = false;
