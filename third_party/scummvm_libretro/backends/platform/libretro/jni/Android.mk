...
MAD_INCLUDE := $(ROOT_PATH)/deps/libretro-deps/libmad
...
LOCAL_SRC_FILES       := $(DETECT_OBJS:%.o=$(SCUMMVM_PATH)/%.cpp)  $(OBJS_DEPS:%.o=%.c) $(OBJS_MODULES:%.o=%.cpp) $(OBJS_CORE:%.o=%.cpp)
LOCAL_C_INCLUDES      := $(subst -I,,$(INCLUDES))
LOCAL_CPPFLAGS        := $(COREFLAGS) -std=c++11 -idirafter$(MAD_INCLUDE)
LOCAL_CFLAGS          := $(COREFLAGS) -idirafter$(MAD_INCLUDE)
